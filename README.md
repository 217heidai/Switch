...
| [sys-clk](https://github.com/zdm65477730/sys-clk) | zdm65477730 | `sys-clk.zip` | `v1.0.2` | 20250801 | `switch_sdcard` | Tesla 超频插件 |
| [MissionControl](https://github.com/ndeadly/MissionControl) | ndeadly | `^MissionControl.*.zip$` | `v0.13.5` | 20250903 | `switch_sdcard` | Tesla 第三方蓝牙手柄支持 |
...
| [dbi](https://github.com/rashevskyv/dbi) | rashevskyv | `dbi.config` | `810` | 20250911 | `switch_sdcard/switch/DBI/dbi.config` | DBI 配置文件 |
