...
| [Horizon-OC](https://github.com/Horizon-OC/Horizon-OC) | Horizon-OC | `dist.zip` | `2.3.0` | 20260511 | `switch_sdcard` | 超频组件 |
| [DBIPatcher](https://github.com/rashevskyv/DBIPatcher) | rashevskyv | `DBI.nro` | `849` | 20251206 | `switch_sdcard/switch/DBI/DBI.nro` | 游戏安装，存档管理和文件传输工具（NRO） |
| [DBIPatcher](https://github.com/rashevskyv/DBIPatcher) | rashevskyv | `translation_zhcn.bin` | `849` | 20251206 | `switch_sdcard/switch/DBI/translation.bin` | DBI 中文插件 |
