...
| [nx-ovlloader](https://github.com/ppkantorski/nx-ovlloader) | ppkantorski | `nx-ovlloader.zip` | `v2.0.2` | 20260523 | `switch_sdcard` | Tesla 启动器 |
| [Ultrahand-Overlay](https://github.com/ppkantorski/Ultrahand-Overlay) | ppkantorski | `ovlmenu.ovl` | `v2.4.2` | 20260523 | `switch_sdcard/switch/.overlays/ovlmenu.ovl` | Tesla 菜单 |
| [Ultrahand-Overlay](https://github.com/ppkantorski/Ultrahand-Overlay) | ppkantorski | `lang.zip` | `v2.4.2` | 20260523 | `switch_sdcard/config/ultrahand/lang` | Tesla 菜单 |
...
| [Horizon-OC](https://github.com/Horizon-OC/Horizon-OC) | Horizon-OC | `dist.zip` | `2.3.1` | 20260520 | `switch_sdcard` | 超频组件 |
