...
| [DBIPatcher](https://github.com/rashevskyv/DBIPatcher) | rashevskyv | `DBI.nro` | `898` | 20260728 | `switch_sdcard/switch/DBI/DBI.nro` | 游戏安装，存档管理和文件传输工具（NRO） |
| [DBIPatcher](https://github.com/rashevskyv/DBIPatcher) | rashevskyv | `translation_zhcn.bin` | `898` | 20260728 | `switch_sdcard/switch/DBI/translation.bin` | DBI 中文插件 |
