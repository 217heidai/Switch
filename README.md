...
| [Ultrahand-Overlay](https://github.com/ppkantorski/Ultrahand-Overlay) | ppkantorski | `sdout.zip` | `v2.5.3` | 20260717 | `switch_sdcard` | Tesla 启动器 |
...
| [Horizon-OC](https://github.com/Horizon-OC/Horizon-OC) | Horizon-OC | `dist.zip` | `2.5.0` | 20260717 | `switch_sdcard` | 超频组件 |
