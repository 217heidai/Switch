...
| [Lockpick_RCMDecScots](https://github.com/zdm65477730/Lockpick_RCMDecScots) | zdm65477730 | `Lockpick_RCM.bin` |  |  | `switch_sdcard/bootloader/payloads/Lockpick_RCM.bin` | 主机系统的密钥提取工具 |
| [TegraExplorer](https://github.com/zdm65477730/TegraExplorer) | zdm65477730 | `TegraExplorer.bin` |  |  | `switch_sdcard/bootloader/payloads/TegraExplorer.bin` | Hekate 下的文件管理工具 |
...
| [sys-clk](https://github.com/zdm65477730/sys-clk) | zdm65477730 | `sys-clk.zip` |  |  | `switch_sdcard` | Tesla 超频插件 |
| [MissionControl](https://github.com/ndeadly/MissionControl) | ndeadly | `^MissionControl.*.zip$` |  |  | `switch_sdcard` | Tesla 第三方蓝牙手柄支持 |
...
| [dbi](https://github.com/rashevskyv/dbi) | rashevskyv | `dbi.config` |  |  | `switch_sdcard/switch/DBI/dbi.config` | DBI 配置文件 |
...
| [NX-Shell](https://github.com/zdm65477730/NX-Shell) | zdm65477730 | `NX-Shell.nro` |  |  | `switch_sdcard/switch/NX-Activity-Log/NX-Shell.nro` | 文件管理工具 |
